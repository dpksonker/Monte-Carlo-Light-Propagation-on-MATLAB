function [Photon,Tissue] = CrossUP(Tissue,Photon,Bound,n)
...
if ee <= Ref || Ref == 1                                                   % Check for reflection at boundary
    ...
    if Photon.Layer == 1                                                   % Check if the photon is at top-most layer                                 
        ...
        [Photon,Tissue] = Reflectance(Bound,Photon,Tissue);                % Then call the function to check for diffuse reflectance
