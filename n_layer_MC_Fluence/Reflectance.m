...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% Reflectance at top layer

Tissue.RR(ia+1,ir+1) = Tissue.RR(ia+1,ir+1) + Photon.weight;           % Diffuse Reflectance stored as escaping angle of photon and coordinate
Tissue.Rr = Tissue.Rr + Photon.weight;                                 % store the weight of exiting photon from first layer
